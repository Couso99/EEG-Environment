...
class edf_writter:
    ...
    def writeEDFHeaders(self):
        self.file.setSignalHeaders(self.channel_info)       #Escribir el encabezado de la señal = información de los canales

    def writeEDFSamples(self, data):
        self.file.writeSamples(data)              #Escribir las muestras

    def firstWriteToEDF(self):
        self.writeEDFHeaders()
        self.writeEDFSamples(self.data_list)

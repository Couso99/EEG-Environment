...
"""
#%%
from GUI.bci_biosignals import Ui_MainWindow as ui
...
class GUI():
    ...
    def __init__(self, app, callbacks):         #Recibe la aplicación completa y una lista de callbacks DESDE MAIN
        ...
        self.bci_graph.btn_loadScript.clicked.connect(self.app.stop_recording)#callbacks[4])
    ...
    def eeg_update(self):
        ...
        #self.app.eeg_dmg = np.hstack((self.all_data_store, sample))
